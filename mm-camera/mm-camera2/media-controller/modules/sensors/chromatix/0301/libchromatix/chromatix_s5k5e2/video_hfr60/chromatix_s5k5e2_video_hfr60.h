...
/******************************************************************************/
      ...
      {
         /* Red channel parameters */
         {158, 176, 2256}, /* 12-bit pixels */
         {0.186000f, 0.000000f},

         /* Green channel parameters */
         {146, 162, 2256}, /* 12-bit pixels */
         {0.139000f, 0.000000f},
         {1.000000f, 1.000000f},
...
/*********************************************************************/
      ...
      /* 7x7 ASF */
      {
         ...
         0, /* neg_abs_y1 */
         {672, 10752, 0}, /* nz [0] for F1, [1] for F2, [2] for F3 and F4 */
         /* F1 */
         {
            /* Lowlight */
            {
               0.000000f, 0.000000f, -0.010000f, -0.010000f,
               0.000000f, -0.010000f, -0.030000f, -0.030000,
         ...
         /* H / Lut1 */
         {
            /* Lowlight */
            {
               0.116733f, 0.209533f, 0.359700f, 0.432367f, 0.448200f, 0.449900f,
               0.450000f, 0.450000f, 0.450000f, 0.450000f, 0.450000f, 0.450000f,
               0.450000f, 0.450000f, 0.450000f, 0.450000f, 0.450000f, 0.450000f,
               0.450000f, 0.450000f, 0.450000f, 0.450000f, 0.450000f, 0.450000f
            },
            /* Normal Light */
...
/******************************************************************************/
         ...
         /* Reference Noise */
         {
            /* Noise Profile 1 */
            {
               80.000000f, /* Trigger Value */
               {
                  6.971648f, 9.828262f, 15.203675f, 18.856241f, 4.456704f, 6.165193f, 11.724882f, 17.936934f,
                  1.018026f, 2.393055f, 5.000000f, 5.000000f, 0.399126f, 0.887398f, 4.143991f, 5.000000f,
                  3.097713f, 5.000000f, 5.000000f, 5.000000f, 1.075177f, 2.703959f, 5.000000f, 5.000000f
               },
               /* Denoise Scale Y */
               {
            ...
            /* Noise Profile 3 */
            {
               200.000000f, /* Trigger Value */
               {
                  6.971648f, 9.828262f, 15.203675f, 18.856241f, 4.456704f, 6.165193f, 11.724882f, 17.936934f,
                  1.018026f, 2.393055f, 5.678993f, 6.666667f, 0.399126f, 0.887398f, 4.143991f, 6.666667f,
                  3.097713f, 6.451255f, 6.666667f, 6.666667f, 1.075177f, 2.703959f, 6.666667f, 6.666667f
               },
               /* Denoise Scale Y */
               {
                  3.000000f, 3.000000f, 3.000000f, 3.000000f
            ...
            /* Noise Profile 5 */
            {
               300.000000f, /* Trigger Value */
               {
                  6.971648f, 9.828262f, 15.203675f, 18.856241f, 4.456704f, 6.165193f, 11.724882f, 17.936934f,
                  1.018026f, 2.393055f, 5.678993f, 8.268271f, 0.399126f, 0.887398f, 4.143991f, 7.951296f,
                  3.097713f, 6.451255f, 10.000000f, 10.000000f, 1.075177f, 2.703959f, 10.000000f, 10.000000f
               },
               /* Denoise Scale Y */
               {
                  3.000000f, 3.000000f, 3.000000f, 3.000000f
...
/******************************************************************************/
         ...
         /* Reference Noise */
         {
            /* Noise Profile 1 */
            {
               201.000000f, /* Trigger Value */
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f, 8.000000f, 4.000000f, 2.000000f, 1.000000f,
                  0.000000f, 0.000000f, 0.000000f, 0.000000f, 8.000000f, 4.000000f, 2.000000f, 1.000000f,
                  0.000000f, 0.000000f, 0.000000f, 0.000000f, 8.000000f, 4.000000f, 2.000000f, 1.000000f,
               },
               /* Denoise Scale Y */
               {
                  12.750000f, 12.750000f, 12.750000f, 12.750000f
               },
               /* Denoise Scale Chroma */
               {
                  12.750000f, 12.750000f, 12.750000f, 12.750000f
...
/******************************************************************************/
   ...
   1.150000f, /* AWB Self-Calibrate AWBExt-Bayer-SelfCalAdjRatioHigh */
   0.900000f, /* AWB Self-Calibrate Adjust Ratio Low */
   /* Purple Prevent */
   {
...
/******************************************************************************/
   ...
   0.000000f, /* Extreme MCC Blue Threshold */
},
/* AEC */
{
   0, /* Software Type */
...
// Number of entries in the exposure table. It needs to be in sync with the table contents.
//
...
// Starting index for lowlight EV control.
//
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      ...
      0, /* Exp Index for Digital Gain for EV Lowlight */
      {
