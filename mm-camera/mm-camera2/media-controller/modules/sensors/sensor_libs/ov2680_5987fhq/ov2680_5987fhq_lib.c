...
#endif
#if PREVIEW_800X600_PARMS
  &ov2680_5987fhq_csi_params, /* RES 1*/
#endif
};
...
static struct sensor_lib_chromatix_t ov2680_5987fhq_chromatix[] = {
  ...
  {
    .common_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(preview), /* RES0 */
    .camera_snapshot_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(preview), /* RES0 */
    .camcorder_chromatix = OV2680_5987FHQ_LOAD_CHROMATIX(default_video), /* RES0 */
  },
#endif
};
