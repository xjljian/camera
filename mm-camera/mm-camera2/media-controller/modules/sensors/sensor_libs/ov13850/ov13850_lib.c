...
static struct msm_camera_i2c_reg_array res0_reg_array[] = {
  ...
  {0x3814,0x11},// ; H inc
  {0x3815,0x11},// ; V inc
  {0x3820,0x00},//0x00},// ; V flip off, V bin off
...
static struct msm_camera_i2c_reg_array res1_reg_array[] = {
  ...
  {0x3814,0x31},// ; H inc
  {0x3815,0x31},// ; V inc
  {0x3820,0x02},//0x02},// ; V flip off, V bin on
  {0x3821,0x05},//0x05},// ; H mirror on, H bin on
  {0x3836,0x08},//
  {0x3837,0x02},//
  {0x4020,0x00},//
  {0x4021,0xe4},//
...
//Raw 10bit 1056x784 60fps 4lane 792M bps/lane
  {0x0300, 0x00},
  {0x0301, 0x00},
  {0x0302, 0x21}, // PLL
  {0x0303, 0x00}, // PLL
  ...
  {0x3807, 0x4f}, // V crop end L
  {0x3808, 0x04}, // H output size H
  {0x3809, 0x20}, // H output size L
  {0x380a, 0x03}, // V output size H
  {0x380b, 0x10}, // V output size L
  {0x380c, 0x12}, // HTS H = 4720
  {0x380d, 0x70}, // HTS L
  {0x380e, 0x06}, // VTS H
  {0x380f, 0x9c}, // VTS L
  {0x3810, 0x00},
  ...
  {0x3814, 0x31}, // H inc
  {0x3815, 0x35}, // V inc
  {0x3820, 0x82}, // V flip off, V bin on
  {0x3821, 0x05}, // H mirror on, H bin on
  {0x3834, 0x02},
  {0x3836, 0x08},
  {0x3837, 0x02},
...
//Raw 10bit 1056x784 90fps 4lane 792M bps/lane
  {0x0300, 0x00},
  {0x0301, 0x00},
  {0x0302, 0x21}, // PLL
  {0x0303, 0x00}, // PLL
...
// Raw 10bit 1056x784 120fps 4lane 792M bps/lane
  {0x0300, 0x00},
  {0x0301, 0x00},
  {0x0302, 0x21}, // PLL
  {0x0303, 0x00}, // PLL
