...
static struct sensor_lib_chromatix_t ov8825_chromatix[] = {
  ...
  {
    .common_chromatix = OV8825_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV8825_LOAD_CHROMATIX(preview_hd), /* RES1 */
    .camera_snapshot_chromatix = OV8825_LOAD_CHROMATIX(snapshot_hd), /* RES1 */
    .camcorder_chromatix = OV8825_LOAD_CHROMATIX(video_hd), /* RES1 */
    .liveshot_chromatix = OV8825_LOAD_CHROMATIX(liveshot_hd), /* RES1 */
  },
  {
    .common_chromatix = OV8825_LOAD_CHROMATIX(common),
