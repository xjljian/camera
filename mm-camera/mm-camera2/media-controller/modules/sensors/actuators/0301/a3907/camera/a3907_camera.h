     ...
     */
      ...
      /* af_tuning_single_t */
      {
         ...
         */
        {
          ...
          380, /* SINGLE_50CM_IDX       */
          410, /* SINGLE_60CM_IDX       */
          450, /* SINGLE_120CM_IDX      */
          500, /* SINGLE_HYP_F_IDX      */
          540, /* SINGLE_INF_LIMIT_IDX  */
        },
         ...
         *  Description: Enable flag to use Preview Assited AF(SW stats)
         ...
         */
        {
          ...
          SINGLE_10CM_IDX,        /* Variable name: srch_rgn_3      */
